            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" style="padding-right: 0px;margin-right: 0px;">
                        <div>
                            <h1 class="text-center" style="margin-top: 30px;font-family: 'Alegreya Sans SC', sans-serif;font-weight: bold;color: rgb(203,12,159);">New Applications</h1>
                            <hr>
                        </div>
                                        ...
                                        <table class="table my-0" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="margin-left: -2px;padding-left: 10px;text-align: center;">Date</th>
                                                    <th style="text-align: center;">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="text-align: center;">Cmk210</td>
                                                    <td style="margin-right: -31px;padding-right: 24px;text-align: center;">201202020202</td>
                                                    <td style="text-align: center;">2008/11/28</td>
                                                    <td style="text-align: center;"><button class="btn btn-primary" type="button" style="text-align: center;">View Application</button></td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <td style="text-align: center;"><strong>Module</strong></td>
                                                    <td style="text-align: center;"><strong style="text-align: center;">Student Number</strong></td>
