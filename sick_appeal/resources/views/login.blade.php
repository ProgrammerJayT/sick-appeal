...
<body style="font-family: 'Alegreya Sans SC', sans-serif;">
    <section>
        <div class="container justify-content-center align-items-center align-content-center" style="padding: 40px;margin-top: 100px;">
            <div class="row">
                <div class="col" style="padding-right: 150px;padding-left: 150px;">
                    <div class="border rounded-pill">
                        <h2 class="display-6 text-center" style="font-family: 'Alegreya Sans SC', sans-serif;padding-top: 10px;padding-bottom: 0px;margin-bottom: 0px;">Welcome Back!</h2>
